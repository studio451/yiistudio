                    ...
                    success: function(response){
                        if(response.result === 'success'){
                            var html = $(photoTemplate
                                ...
                                .replace(/\{\{photo_description\}\}/g, response.photo.description))
                                .hide();
                ...
                $.post(
                    ...
                    function(response){
                        if(response.result === 'success'){
                            ...
                            tr.find('.photo-box').attr('title', text);
                        }
                        else{
                            alert(response.error);
                        }
    ...
    photosBody.on('change', '.change-image-input', function(){
        ...
        $.ajax({
            ...
            success: function(response){
                ...
                if(response.result === 'success'){
                    tr.find('.photo-box').attr('href', response.photo.image).children('img').attr('src', response.photo.thumb);
                    notify.success(response.message);
                }else{
                    alert(response.error);
                }
