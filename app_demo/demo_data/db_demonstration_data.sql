...
(9, 1, '8(495)123-45-67', 'Алексей', 'г. Москва, ул. Строителей, 1', 'admin@yiistudio.ru', 'Нужна быстрая доставка', '', 1, 0, 'Доставка курьером', 3, 'Онлайн-оплата', 1, 1525186109, 'Статус оплаты заказа изменен в панели управления на \"Оплачен\"', 0, '[]', 'l44OftThZHxnLbrVJsgZutFzwW8Qbhz8', '31.135.211.1', 1525185965, 0, 7);
