...
--
-- Дамп данных таблицы `admin_module_sale`
--

INSERT INTO `admin_module_sale` (`id`, `title`, `image`, `short`, `banner_background_color`, `banner_border_color`, `banner_title`, `banner_content_text`, `banner_content_button`, `text`, `slug`, `time`, `views`, `status`) VALUES
(1, 'Подарок к заказу от 5000 руб.!', '', 'Подарок к заказу от 5000 руб.!', '#484848', '#333333', 'Красивый чехол', 'При заказе от 5000 руб', 'Подробнее', '<p>Подарок к каждому заказу от 5000 руб. Модный чехол!!!</p>', 'podarok_k_zakazu_ot_5000_rub', 1554366832, 3, 1),
(2, 'Бесплатная доставка при заказе более 2500 руб.', '', 'Бесплатная доставка при заказе более 2500 руб.', '#337ab7', '#2e6da4', 'Бесплатная доставка', 'При заказе от 2500 руб', 'Подробнее', '<p>Бесплатная доставка при заказе более 2500 руб. в пределах МКАД и за МКАД до 10 км.</p>', 'besplatnaya_dostavka_pri_zakaze_bolee_2500_rub', 1554366947, 1, 1);
